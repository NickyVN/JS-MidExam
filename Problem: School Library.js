...
console.log('---------------------------------------------------');
readArr(["Anna Karenina&Heart of Darkness&Catch-22&The Stranger", "Add Book | Catch-22", "Swap Books | Anna Karenina | Catch-22", "Take Book | David Copperfield", "Done"])
console.log('---------------------------------------------------');
readArr(["War and Peace&Hamlet&Ulysses&Madame Bovary", "Check Book | 2", "Swap Books | Don Quixote | Ulysses", "Done"])
